...
public static class ModCompatibility
{
    ...
    public static class FargoCrossmod
    {
    ...
    public static class RedemptionBardHealer
    {
        public const string Name = "RedemptionBardHealer";
        public static bool Loaded => ModLoader.HasMod(Name);
        public static Mod Mod => ModLoader.GetMod(Name);
    }
    public static class SpritBardHealer
    {
        public const string Name = "SpiritBardHealer";
        public static bool Loaded => ModLoader.HasMod(Name);
        public static Mod Mod => ModLoader.GetMod(Name);
    }
    public static class CalamityBardHealer
    {
    ...
    public static class GerdsLab
    {
        public const string Name = "GMR";
        public static bool Loaded => ModLoader.HasMod(Name);
        public static Mod Mod => ModLoader.GetMod(Name);
    }
