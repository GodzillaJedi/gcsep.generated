...
namespace gcsep.Content.NPCs.MutantEX.Projectiles;
...
public class MutantBoss : ModProjectile
{
    ...
    public override bool PreDraw(ref Color lightColor)
    {
        ...
        Texture2D aura = ModContent.Request<Texture2D>("gcsep/Assets/ExtraTextures/MutantEX/MutantAura", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value;
        ...
        if (this.sansEye)
        {
            ...
            Texture2D star = ModContent.Request<Texture2D>("gcsep/Assets/ExtraTextures/MutantEX/LifeStar", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value;
