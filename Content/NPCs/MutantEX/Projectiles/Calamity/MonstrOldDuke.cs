...
namespace gcsep.Content.NPCs.MutantEX.Projectiles.Calamity
{
    [JITWhenModsEnabled(ModCompatibility.Calamity.Name)]
    [ExtendsFromMod(ModCompatibility.Calamity.Name)]
    public class MonstrOldDuke : ModProjectile
    {
        ...
        public override void AI()
        {
            if (Projectile.localAI[1] == 0f)
            {
                ...
                p = GCSEUtils.AnyBossAlive() ? Main.npc[FargoSoulsGlobalNPC.boss].target : Player.FindClosest(Projectile.Center, 0, 0);
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            if (Projectile.localAI[0] > 85f)
            {
                ...
                {
                    Color color27 = Color.Lerp(color26, Color.Green, 0.25f);
