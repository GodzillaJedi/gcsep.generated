...
namespace gcsep.Content.NPCs.MutantEX
{
    public class MonstrosityBoss : ModProjectile
    {
        ...
        public override string Texture => "gcsep/Content/NPCs/MutantEX/MutantEX";
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D texture2D14 = ModContent.Request<Texture2D>("gcsep/Assets/ExtraTextures/MutantEX/MutantSoul", AssetRequestMode.ImmediateLoad).Value;
            int num156 = TextureAssets.Projectile[Projectile.type].Value.Height / Main.projFrames[Projectile.type];
            int y3 = num156 * Projectile.frame;
            Rectangle rectangle = new Rectangle(0, y3, texture2D13.Width, num156);
            Vector2 origin2 = rectangle.Size() / 2f;
            Texture2D aura = ModContent.Request<Texture2D>("gcsep/Assets/ExtraTextures/MutantEX/MutantAura", AssetRequestMode.ImmediateLoad).Value;
            ...
            if (sansEye)
            {
                ...
                Texture2D star = ModContent.Request<Texture2D>("gcsep/Assets/ExtraTextures/MutantEX/LifeStar", AssetRequestMode.ImmediateLoad).Value;
