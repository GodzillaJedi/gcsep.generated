    ...
    public class Monstrosity : ModNPC
    {
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[] {
                ...
                new FlavorTextBestiaryInfoElement("Mods.gcsep.Bestiary.Monstrosity")});
        }
        public override void SetDefaults()
        {
            ...
            if (FargoSoulsUtil.AprilFools)
                NPC.GivenName = Language.GetTextValue("Mods.gcsep.NPCs.Monstrosity.DisplayNameApril");
        }
