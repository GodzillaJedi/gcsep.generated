...
namespace gcsep.Content.Tiles
{
    ...
    public abstract class BaseRelic : ModTile
    {
        ...
        private const string path = "gcsep/Content/Tiles/";

        public Asset<Texture2D> RelicTexture;

        protected abstract int ItemType { get; }

        protected string RelicTextureName => "gcsep/Content/Tiles/" + Name;

        public override string Texture => "gcsep/Content/Tiles/RelicPedestal";
