    ...
    public class MutantEXSky : CustomSky
    {
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (FargoSoulsUtil.BossIsAlive(ref GCSENpcs.mutantEX, ModContent.NPCType<MutantEX>())
                && (Main.npc[GCSENpcs.mutantEX].ai[0] < 0 || Main.npc[GCSENpcs.mutantEX].ai[0] >= 10))
            {
                intensity += increment;
                lifeIntensity = Main.npc[GCSENpcs.mutantEX].ai[0] < 0 ? 1f : 1f - (float)Main.npc[GCSENpcs.mutantEX].life / Main.npc[GCSENpcs.mutantEX].lifeMax;
                ...
                switch ((int)Main.npc[GCSENpcs.mutantEX].ai[0])
                {
                    case -5:
                        if (Main.npc[GCSENpcs.mutantEX].ai[2] >= 420)
                    ...
                    case 36:
                        if (Main.npc[GCSENpcs.mutantEX].ai[2] > 180 * 3 - 60)
