...
namespace gcsep.Content.Projectiles.Minions
{
    public class MutantSoul : ModProjectile
    {
        public override string Texture => "gcsep/Content/Projectiles/Minions/MutantSoul";
        ...
        public override void AI()
        {
            ...
            if (player.active && !player.dead && player.GetModPlayer<GCSEPlayer>().equippedPhantasmalEnchantment)
