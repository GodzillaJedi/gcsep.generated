...
using static gcsep.Thorium.Enchantments.JesterEnchant;
using FargowiltasSouls;
using FargowiltasSouls.Core.AccessoryEffectSystem;
using gcsep.Content.Projectiles.Enchantments;
using gcsep.Core;

namespace gcsep.Content.Projectiles
{
    [ExtendsFromMod(ModCompatibility.Thorium.Name)]
    [JITWhenModsEnabled(ModCompatibility.Thorium.Name)]
    public class MinionBellProj : ModProjectile
    {
        public override string Texture => "gcsep/Content/Items/SwarmDeactivatorDebug";
