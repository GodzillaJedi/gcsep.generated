...
namespace gcsep.Crossmod.Boots
{
    ...
    */
    ...
    public class TorBootsRecepies : ModSystem
    {
        ...
        {
            return GCSEConfig.Instance.Boots && !ModLoader.HasMod(ModCompatibility.Calamity.Name) && !ModLoader.HasMod(ModCompatibility.SacredTools.Name);
        }
    ...
    public class TorBootsEffects : GlobalItem
    {
        public override bool IsLoadingEnabled(Mod mod)
        {
            return GCSEConfig.Instance.Boots && !ModLoader.HasMod(ModCompatibility.SacredTools.Name) && !ModLoader.HasMod(ModCompatibility.Calamity.Name);
        }
