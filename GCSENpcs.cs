...
namespace gcsep
{
    public partial class GCSENpcs : GlobalNPC
    {
        ...
        public override void Load()
        {
            ...
            if (ModCompatibility.Calamity.Loaded) { multiplierM += GCSEConfig.Instance.DebugMode ? 8.8f : 2.8f; multiplierA += 6f; }
        ...
        public override void OnHitNPC(NPC npc, NPC target, NPC.HitInfo hit)
        {
            ...
            {
                target.AddBuff(ModContent.BuffType<MonstrosityPresenceBuff>(), 180);
            }
        }
        ...
        public override void SetDefaults(NPC npc)
        {
            ...
            if (npc.type == ModContent.NPCType<MutantBoss>())
            {
                ...
                {
                    npc.damage = 750;
                    npc.lifeMax = GCSEConfig.Instance.SecretBosses ? 40000000 : 35000000;
                }
                ...
                {
                    npc.damage = 700;
                    npc.lifeMax = GCSEConfig.Instance.SecretBosses ? 35000000 : 30000000;
                }
                ...
                {
                    npc.damage = 600;
                    npc.lifeMax = GCSEConfig.Instance.SecretBosses ? 20000000 : 15000000;
                }
                ...
                {
                    npc.damage = 800;
                    npc.lifeMax = GCSEConfig.Instance.SecretBosses ? 4500000 : 40000000;
                }
                ...
                {
                    npc.damage = 500;
                    npc.lifeMax = GCSEConfig.Instance.SecretBosses ? 15000000 : 10000000;
                }
        ...
        {
            if (gcsep.SwarmNoHyperActive)
            {
                return true;
            }

            //if (gcsep.EndgameSwarmActive && Main.GameUpdateCount % 5 == 0)
            //{
            //   return true;
            //}

            if (gcsep.PostMLSwarmActive && Main.GameUpdateCount % 4 == 0)
            {
                return true;
            }

            //if (gcsep.LateHardmodeSwarmActive && Main.GameUpdateCount % 3 == 0)
            //{
            // return true;
            //}

            if (gcsep.HardmodeSwarmActive && Main.GameUpdateCount % 2 == 0)
            {
                return true;
            }

            if (gcsep.SwarmActive && !npc.townNPC && npc.lifeMax > 1 && go < 2)
            {
                go++;
                npc.AI();
                float num = 0.5f;
