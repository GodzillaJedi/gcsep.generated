...
namespace gcsep.SoA.InfAmmo
{
    ...
    {
        public override string Texture => "gcsep/SoA/InfAmmo/FlariumRenewal";
    ...
    {
        public override string Texture => "gcsep/SoA/InfAmmo/FlariumRenewalSupreme";
