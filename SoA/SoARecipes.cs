...
namespace gcsep
{
    ...
    public class SoARecipes : ModSystem
    {
        public override void AddRecipeGroups()
        {
            ...
            RecipeGroup.RegisterGroup("gcsep:AsthralHelms", rec);
            ...
            RecipeGroup.RegisterGroup("gcsep:FlariumHelms", rec2);
            ...
            RecipeGroup.RegisterGroup("gcsep:VoidWardenChest", rec3);
        }
        ...
        public override void PostAddRecipes()
        {
            for (int i = 0; i < Recipe.numRecipes; i++)
            {
                ...
                if (GCSEConfig.Instance.SacredTools && recipe.HasResult<EternitySoul>() && !recipe.HasIngredient<SoASoul>())
                {
