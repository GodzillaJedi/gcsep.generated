...
namespace gcsep.SoA.Enchantments
{
    ...
    public class BlazingBruteEnchant : BaseEnchant
    {
        ...
        public override void UpdateAccessory(Player player, bool hideVisual)
        {
            ...
            player.AddEffect<BlazingBruteHelmEffect>(Item);
        }

        public class BlazingBruteHelmEffect : AccessoryEffect
        {
            ...
            {
                ModContent.GetInstance<BlazingBruteHelm>().UpdateArmorSet(player);
            }
        }
