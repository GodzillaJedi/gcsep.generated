...
using static gcsep.SoA.Enchantments.BlightboneEnchant;
...
namespace gcsep.SoA.Enchantments
{
    ...
    public class DreadfireEnchant : BaseEnchant
    {
        ...
        public override void UpdateAccessory(Player player, bool hideVisual)
        {
            ...
            player.AddEffect<DreadfireMaskEffect>(Item);
            if (player.AddEffect<DreadflameAmuletEffect>(Item))
            {
                ModContent.GetInstance<DreadflameEmblem>().UpdateAccessory(player, hideVisual);
            }
        }
        public class DreadflameAmuletEffect : AccessoryEffect
        {
        ...
        public class DreadfireMaskEffect : AccessoryEffect
        {
            public override Header ToggleHeader => Header.GetHeader<GenerationsForceHeader>();
            public override int ToggleItemType => ModContent.ItemType<DreadfireEnchant>();
            public override void PostUpdateEquips(Player player)
            {
                ModContent.GetInstance<DreadfireMask>().UpdateArmorSet(player);
            }
        }
