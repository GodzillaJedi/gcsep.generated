...
namespace gcsep
{
    ...
    public class GCSEConfig : ModConfig
    {
        public override ConfigScope Mode => ConfigScope.ServerSide;
        public static GCSEConfig Instance;
        ...
        [BackgroundColor(60, 200, 60, 192)]
        [DefaultValue(true)]
        public bool SOTS { get; set; }

        [ReloadRequired]
        [BackgroundColor(60, 200, 60, 192)]
        [DefaultValue(true)]
        public bool RagnarokMod { get; set; }
        
        [ReloadRequired]
        [BackgroundColor(60, 200, 60, 192)]
        [DefaultValue(true)]
        public bool OrchidMod { get; set; }
